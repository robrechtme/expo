...
To get started, prepare your identity provider (IdP) for Expo SSO and gather information by following the [configuration guide for your IdP](/#identity-provider-support) below. Once you have done this, the owner of your Organization can follow instructions to [enable SSO](#enable-sso).
...
<Step label="3">
	Enter the configuration details for your IdP in the form, using the information you collected during the IdP setup:
  - client ID
  - client secret
...
<Step label="5">
  The **Organization settings** > **Overview** page will now display an **Update SSO configuration** option. Use this option to update the client secret when it has changed.
</Step>
