...
- Prevent special characters from being used in JS/CSS asset output filenames. ([#29689](https://github.com/expo/expo/pull/29689) by [@kitten](https://github.com/kitten))
