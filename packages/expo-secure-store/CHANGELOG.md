...
- [Android] Fix decryption errors after Android Auto Backup has restored `expo-secure-store` data. - [Android] Fix decryption errors after Android Auto Backup has restored `expo-secure-store` data. ([#29943](https://github.com/expo/expo/pull/29943) by [@behenate](https://github.com/behenate))
